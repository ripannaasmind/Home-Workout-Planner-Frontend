                  ...
                  <tr key={w._id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                    <td className="px-4 py-3">
                      {(w as Workout & { image?: string }).image ? (
                        <Image src={(w as Workout & { image?: string }).image!} alt={w.name} width={48} height={48} className="h-12 w-12 object-cover rounded-xl border border-gray-200 shadow-sm" unoptimized />
                      ) : (
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-end gap-2">
                        <Button size="sm" variant="ghost" className="h-8 w-8 p-0 text-gray-500 hover:text-primary" onClick={() => openEdit(w)}>
                          <Edit2 className="h-4 w-4" />
                        </Button>
                        <Button size="sm" variant="ghost" className="h-8 w-8 p-0 text-red-500 hover:text-red-700" onClick={() => setDeleteTarget(w)}>
