  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-gray-100">Product Management</h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Manage shop products</p>
        </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50">
                  ...
                  <th className="text-left px-4 py-3 text-gray-500 dark:text-gray-400 font-medium">Price</th>
                  <th className="text-left px-4 py-3 text-gray-500 dark:text-gray-400 font-medium">Stock</th>
                  <th className="text-left px-4 py-3 text-gray-500 dark:text-gray-400 font-medium">Featured</th>
                  ...
                  <tr key={p._id || p.id} className="border-b border-gray-50 dark:border-gray-800 hover:bg-gray-50 dark:bg-gray-800/50 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      {p.featured ? (
                        ...
                        <Badge className="bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 border-0">No</Badge>
                      )}
                    </td>
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <Button size="sm" variant="ghost" className="h-8 w-8 p-0 rounded-lg border border-gray-200 dark:border-gray-800 text-red-500 hover:bg-red-500 hover:text-white hover:border-red-500 transition-colors" onClick={() => setDeleteTarget(p)}>
        ...
        <DialogContent aria-describedby={undefined} className="sm:max-w-lg">
          ...
          <div className="space-y-4 py-2 max-h-[60vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                {categories.length > 0 ? (
                  ...
                  <Input value={form.category} onChange={(e) => setForm({ ...form, category: e.target.value })} className="border-gray-200 dark:border-gray-800" />
                )}
              </div>
              <div>
                <Label className="text-sm text-gray-700 dark:text-gray-200 mb-1.5 block">Stock</Label>
                <Input type="number" min={0} value={form.stock} onChange={(e) => setForm({ ...form, stock: Number(e.target.value) })} className="border-gray-200 dark:border-gray-800" />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div>
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <Label htmlFor="featured" className="text-sm text-gray-700 dark:text-gray-200 cursor-pointer">Featured product</Label>
            </div>
          </div>
          <DialogFooter>
