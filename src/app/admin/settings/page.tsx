                ...
                <CardContent className="pt-4 space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      {[{ v: "deepseek", l: "DeepSeek" }, { v: "openai", l: "OpenAI" }, { v: "gemini", l: "Google Gemini" }, { v: "openrouter", l: "OpenRouter" }, { v: "zai", l: "Z.AI (GLM)" }].map((p) => (
                        <button
                          key={p.v}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        placeholder={`Enter your ${aiProvider === "gemini" ? "Google Gemini" : aiProvider === "deepseek" ? "DeepSeek" : aiProvider === "openrouter" ? "OpenRouter" : aiProvider === "zai" ? "Z.AI" : "OpenAI"} API key...`}
                        value={aiApiKey}
                  ...
                  <div className="p-3 bg-purple-50 dark:bg-purple-500/10 rounded-lg border border-purple-100 dark:border-purple-500/20">
                    <p className="text-xs text-purple-700 dark:text-purple-400">
                      {aiProvider === "gemini"
                        ...
                        : aiProvider === "zai"
                        ? "Get your API key from z.ai/manage-apikey/apikey-list — free GLM models available"
