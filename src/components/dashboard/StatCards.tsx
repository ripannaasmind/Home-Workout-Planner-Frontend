    ...
    <div className="grid grid-cols-2 gap-3 sm:gap-4">
      {stats.map((stat, i) => {
        ...
        return (
          <div
            key={i}
            className="bg-white rounded-2xl border border-gray-100 shadow-sm p-3 sm:p-5 flex items-center gap-2 sm:gap-4 overflow-hidden"
          >
            <div
            ...
            <div className="min-w-0">
              <p className="text-xs sm:text-sm text-gray-500 font-medium leading-tight truncate">{stat.label}</p>
