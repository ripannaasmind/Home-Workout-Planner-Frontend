...
export function Hero() {
  return (
    <section className="relative overflow-hidden hero-bg">
      <div className="relative min-h-130 lg:min-h-155 grid grid-cols-1 lg:grid-cols-[2fr_3fr]">
        ...
        <motion.div
          ...
          className="flex flex-col justify-center gap-5 px-6 sm:px-10 lg:px-16 py-12 lg:py-16 text-left order-2 lg:order-1 z-10"
        >
        ...
        <motion.div
          ...
          className="relative order-1 lg:order-2 flex items-end justify-center lg:justify-end"
        >
          <Image
            src="/hero.png"
            alt="FitHome Workout"
            ...
            unoptimized
            priority
            className="w-full max-w-sm sm:max-w-md lg:max-w-none lg:w-full h-auto object-contain object-bottom"
          />
        </motion.div>
